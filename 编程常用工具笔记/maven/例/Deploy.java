package com.rongji.egov.urger.web;
...
public class Deploy {
    ...
    public static final String BASE_CMD = "cmd /c mvn " +
            "-s D:\\programming\\versionControl\\apache-maven-3.6.1-bin\\apache-maven-3.6.1\\conf\\settings.xml " +
            "deploy:deploy-file " +
            "-Durl=http://192.168.0.40:8081/repository/releases/ " +
    ...
    public static void main(String[] args) {
        deploy(new File("F:\\maven").listFiles());
//        if(checkArgs(args)){
